  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-xl border bg-background/50 px-4 py-2 text-sm whitespace-nowrap shadow-sm transition-all duration-200 outline-none",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-2 rounded-lg py-2.5 pr-10 pl-3 text-sm outline-hidden select-none transition-colors duration-150",
